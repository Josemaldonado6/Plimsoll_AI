        ...
        <div className={cn(
            ...
            <div className={cn("p-6 flex flex-col h-full space-y-8", !isOpen && "hidden")}>
                ...
                <div className="space-y-4">
                    ...
                    <button className="w-full bg-yellow-400/10 border border-yellow-400/20 rounded-lg p-3 flex items-center justify-between group hover:bg-yellow-400/20 transition-all">
                    ...
                    <div className="text-[7px] text-slate-500 leading-relaxed italic">
                        CubicSpline ISO-12217 ACTIVE. TPC precision is currently locked to {vesselInfo.name || 'default vessel'}.
                    </div>
                </div>

                <div className="mt-auto pt-4 border-t border-white/10">
                    <button className="w-full bg-yellow-400 p-4 rounded-xl flex items-center justify-center gap-2 text-black font-black text-xs hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-yellow-400/10">
                        <Save size={14} />
