    ...
    def generate_report(self, survey_data: dict, evidence_path: str, lang: str = 'en') -> str:
        ...
        if evidence_path and os.path.exists(evidence_path):
            try:
                ...
                c.setFillColor(colors.black)
                c.setFont("Courier", 8)
                tech_data = "Resolution: 4K | Sensor: CMOS 4/3 | Correction: Orthorectified | Process: Auto-Crop (ROI)"
        ...
        c.setFillColor(colors.darkgrey)
        legal_text = "This draft survey audit was generated by Plimsoll AI Autonomous Engine v1.0. The measurements are derived from"
        legal_text_2 = "computer vision analysis and are cryptographically signed. Any alteration of this digital file invalidates the SHA-256 signature."
        ...
        try:
            ...
            c.drawString(50, 800, "BLOCKCHAIN IMMUTABILITY RECORD")
            
            c.setFont("Helvetica", 10)
            c.drawString(50, 770, "This document has been cryptographically notarized on the Plimsoll Private Ledger.")
            c.drawString(50, 755, "Any modification to the digital file will invalidate this hash.")
            ...
            c.setFont("Helvetica-Bold", 12)
            c.drawString(70, 615, "✓ VERIFIED BY PLIMSOLL SMART CONTRACT (ERC-721)")
        except Exception as e:
